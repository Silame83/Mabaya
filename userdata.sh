...
sudo mysql -e "CREATE USER 'ubuntu'@'localhost' IDENTIFIED BY 'Silame83@gmail.com'"
sudo mysql -e "GRANT ALL ON *.* TO 'ubuntu'@'localhost'"
sudo mysql -e "CREATE DATABASE mabaya"
